"""Generate site and app icons from the Freewrite app artwork (black F, red dot)."""
...
SOURCE_URL = (
    "https://raw.githubusercontent.com/farzaa/freewrite/main/"
    "freewrite/Assets.xcassets/AppIcon.appiconset/512-mac.png"
)
...
def main() -> None:
    ...
    print("Generated Freewrite app icons in", site_icons)
